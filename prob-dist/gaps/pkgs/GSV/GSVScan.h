...
public:
  ...
  GSVScanline *FindScanlineBeforeTravelDistance(RNScalar travel_distance) const;
...
protected:
  ...
  GSVScanline *FindScanlineBeforeTravelDistance(RNScalar travel_distance, int imin, int imax) const;
