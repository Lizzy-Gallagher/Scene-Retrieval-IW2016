...
class GSVMesh : public R3Mesh {
  public:
    ...
    virtual int WritePlyFile(GSVScan *scan, const char *filename, RNBoolean binary = TRUE);
    virtual int WriteARFFFile(GSVScan *scan, const char *filename);
...
public:
    ...
    virtual R3MeshType Intersection(const R3Ray& ray, R3MeshIntersection *intersection = NULL, 
