...
public:
  ...
  int CreateMeshCorrespondences(void);
  int CreateMeshCorrespondences(RNScalar correspondences_per_cubic_meter);
  int CreateMeshCorrespondences(GSVMesh *mesh1, GSVMesh *mesh20, GSVMesh *mesh22, int max_correspondences);
  int CreateMeshCorrespondence(GSVMesh *mesh1, GSVMesh *mesh20, GSVMesh *mesh22);
